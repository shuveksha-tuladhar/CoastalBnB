    ...
    return (
        <div className="show-page-images"> 
            <div className='property-show-idx-div'>
                    <img className="property-show-image-main" src={property.imageUrls[0]} alt='' />
                </div>
             <div className='show-page-small-images'>
                    <img className="property-show-image-small" src={property.imageUrls[1]} alt='' />
                    <img className="property-show-image-small" src={property.imageUrls[2]} alt='' />
                    <img className="property-show-image-small" src={property.imageUrls[1]} alt='' />
                    <img className="property-show-image-small" src={property.imageUrls[2]} alt='' />
                </div>
        </div>
