  ...
  const reviews =  [
    {
      ...
      User: {
        ...
        avatarUrl: "https://gravatar.com/avatar/0702e63f4e9cb23ad9928fbda8f3f9f3?s=400&d=robohash&r=x"
    },
    },
    {
      userId: 2,
    ...
    {property?.imageUrls && (
      ...
      <div id="property-show-page">
        ...
        <span>
          ...
          {property.bedrooms > 1 ? "bedrooms" : "bedroom"} · {property.bedrooms}{" "}
          {property.bedrooms > 1 ? "beds" : "bed"} · {property.baths}{" "}
          {property.baths > 1 ? "bathrooms" : "bathroom"}
        </span>
